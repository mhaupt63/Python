...
df.groupby(['Gender', 'ExamYear']).apply(lambda x: [np.mean(x['Grade']), np.mean(x['Grade_2'])])
df.groupby(['Gender', 'ExamYear']).apply(lambda x: pd.Series([np.mean(x['Grade']), np.mean(x['Grade_2'])], index = ['Grade', 'Grade_2']))
